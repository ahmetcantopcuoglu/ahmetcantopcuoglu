Hi there! 👋 I'm Ahmet Can Topcuoğlu

🚀 About Me

I'm a junior software developer and chemical engineer who is passionate about mobile application development. Currently, I develop Android applications using Kotlin, focusing on projects that integrate Room Database, ViewBinding, RecyclerView, and API connections. I enjoy building simple yet functional apps and continuously learning new technologies.
...
[Yastık Altı App](https://play.google.com/store/apps/details?id=com.yastikalti.app&hl=tr) - A financial tracking app for managing currency and gold investments.


[Egitici Matematik Game](https://play.google.com/store/apps/details?id=com.PTAGameCraft.EiticiMatematik&hl=tr) - A simple math game available on Google Play.
